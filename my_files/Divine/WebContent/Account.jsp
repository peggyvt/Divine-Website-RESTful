...
<html>
    ...
    <body>
        ...
        <% user_email = (String)session.getAttribute("user_email");
           if (user_email.contentEquals("admin@gmail.com")) { %>
		        <nav class="mx-auto">
		            <div class="container">
            ...
            <nav class="mx-auto">
                <div class="container">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Account.jsp" type="button" class="dropdown-toggle" data-toggle="dropdown">
                                OUR COLLECTIONS
                            </a>
        ...
        <div class="extras" align="right">
            ...
            <% } else if (user_email.contentEquals("admin@gmail.com")) { %>
            ...
            <div class="text-1 mx-auto" width="65%">
                ...
                <% user_email = (String)session.getAttribute("user_email"); 
        		   if (!user_email.equals("guest@gmail.com")) { // check if there is someone signed in %>
	                    ...
	                    <form method='POST'> 
		                    <label class='first_name-label' for='first_name'>FIRST NAME</label><br/>
		                    <input type='text' id='first_name' name='first_name' value='<% out.println(first_name); %>' aria-label='first name' pattern='\S+.*'><br/>
		
		                    <label class='surname-label' for='surname'>SURNAME</label><br/>
		                    <input type='text' id='surname' name='surname' value='<% out.println(surname); %>' aria-label='surname' pattern='\S+.*'><br/>
		
		                    <label class='email-label-2' for='email'>EMAIL</label><br/>
		                    <input type='text' id='email' name='email' value='<% out.println(email); %>' aria-label='email' readonly pattern='\S+.*'><br/>
		
		                    <label class='password-label-2' for='password'>PASSWORD</label><br/>
		                    <input type='text' id='password' name='password' value='<% out.println(password); %>' aria-label='password' pattern='[A-Za-zΑ-Ωα-ω]{0, 20}'><br/>
		                    
		                    <input type='submit' id='update-user-details-btn' aria-label='update user details button' class='update-user-details-btn' name='update-user-details-btn' value='UPDATE'/>
		                </form>
                <% } else { %>
                    <h2>HELLO</h2>
