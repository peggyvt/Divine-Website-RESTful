...
<html>
    ...
    <body>
        ...
        <nav class="mx-auto">
            <div class="container">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Inspiration.jsp" type="button" class="dropdown-toggle" data-toggle="dropdown">
                            OUR COLLECTIONS
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="Inspiration.jsp">INSPIRATION</a>
                    </li>
                    <li class="nav-item">
        ...
        <div>
            <h2>WE TAKE THE ART OF CANDLE MAKING CRAZY SERIOUSLY</h2>
            <div class="text-1 mx-auto" width="65%">
                From working with master local perfumers and sourcing the highest quality ingredients to utilizing state-of-the-art techniques and timeless craftsmanship, we pay meticulous attention to every critical detail when designing the ultimate scented candle. <br>At Divine, our number-one goal is creating the most beautiful fragrance with the strongest impact that a true candle lover craves, so we fill your world with an unforgettable fragrance experience every time.<br><br>
            </div>
            <h2>FRAGRANCE FIRST</h2>
            <div class="text-2 mx-auto" width="65%">
                Our candle-making journey begins with inspiration that ultimately becomes fabulous fragrances that are so beautiful and impactful that they trigger positive emotions that make us feel amazing. The inspiration can be a blend of cherished scents, memories, people, places or even just wonderful feelings that can be difficult to put into words. We work with master local perfumers to develop our crazy-strong fragrances with a blend of natural essential oils and other premium fragrance compounds specifically formulated to deliver both maximum beauty and strength when lit (and also when not).<br>
                The base, middle and top notes of our fragrances are designed to deliver a beautiful, crazy-strong initial impact, as well as ongoing intensity throughout the burn—and long afterwards. We do extensive testing on every aspect of our fragrance oils, as each complex formulation is comprised of a large number of fragrance compounds (but not too many), which is key for a luxurious, beautiful core. Critical to achieving the most beautifully impactful Divine fragrance experience is a concentration of 16% fragrance oil in every candle, the highest amount possible in a candle, which is 50% more than the average luxury scented candle.
            </div>
        </div>
        <footer>
            &copy DIVINE, 2022
