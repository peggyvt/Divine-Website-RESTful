...
<html>
    <head>
        ...
        <title>DIVINE | Silhouette Collection</title>
           		...
           		<div class="row">
                    <%	    	            
	            		...
	            		try {
	            			...
	            			ResultSet rs;
	            			PreparedStatement ps = conn.prepareStatement("SELECT * FROM products WHERE collection = 'SILHOUETTE'");
	                        rs = ps.executeQuery();
	                        ...
	                        { 
	                        	...
	                        	<div class="col-md-3">
                            		<button style="background-color: white; border: none; outline: none;" type="button" data-toggle="modal" data-target="#silhouette-Modal-<%out.print(i);%>"><img class="img-fluid w-100 img" src="<%out.print(img);%>" size="50%" alt="candle image"></button>
		                            ...
		                            <!--ITEM MODAL-->
		                            <div class="modal" id="silhouette-Modal-<%out.print(i);%>">
